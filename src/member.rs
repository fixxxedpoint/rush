    ...
    SH: SpawnHandle,
{
    ...
    >(
        ...
        let mut consensus_finished = false;
        let mut network_finished = false;
        let mut alerter_finished = false;
        ...
        loop {
            futures::select! {
                ...
                _ = &mut consensus_handle => { consensus_finished = true; break;},
                _ = &mut network_handle => { network_finished = true; break; },
                _ = &mut alerts_handle => { alerter_finished = true; break; },
                _ = &mut exit => break,
            }
